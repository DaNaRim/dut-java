package sem1; /******************************************************************************
 *  Compilation:  javac forGirls.std.StdIn.java
 *  Execution:    java forGirls.std.StdIn   (interactive test of basic functionality)
 *  Dependencies: none
 *
...
/**
 *  The {@code forGirls.std.StdIn} class provides static methods for reading strings
 ...
 *  <pre>
 *  while (!forGirls.std.StdIn.isEmpty()) {
 *      double value = forGirls.std.StdIn.readDouble();
 *      forGirls.std.StdOut.println(value);
 *  }
 *  forGirls.std.StdOut.println(sum);
 *  </pre>
 *  <p>
 ...
 *  <pre>
 *  while (forGirls.std.StdIn.hasNextChar()) {
 *      char c = forGirls.std.StdIn.readChar();
 *      forGirls.std.StdOut.print(c);
 *  }
 *  </pre>
 *  <p>
 ...
 *  <pre>
 *  while (forGirls.std.StdIn.hasNextLine()) {
 *      String line = forGirls.std.StdIn.readLine();
 *      forGirls.std.StdOut.println(line);
 *  }
 *  </pre>
 *  <p>
 ...
 *  <pre>
 *  String[] words = forGirls.std.StdIn.readAllStrings();
 *  </pre>
 *  <p>
 *  <b>Differences with Scanner.</b>
 *  {@code forGirls.std.StdIn} and {@link Scanner} are both designed to parse
 *  tokens and convert them to primitive types and strings.
 *  The main differences are summarized below:
 *  <ul>
 *  <li> {@code forGirls.std.StdIn} is a set of static methods and reads
 ...
 *       and sockets.
 *  <li> {@code forGirls.std.StdIn} uses whitespace as the delimiter pattern
 *       that separates tokens.
 *       {@link Scanner} supports arbitrary delimiter patterns.
 *  <li> {@code forGirls.std.StdIn} coerces the character-set encoding to UTF-8,
 *       which is the most widely used character encoding for Unicode.
 *  <li> {@code forGirls.std.StdIn} coerces the locale to {@link Locale#US},
 *       for consistency with {@link StdOut}, {@link Double#parseDouble(String)},
 *       and floating-point literals.
 *  <li> {@code forGirls.std.StdIn} has convenient methods for reading a single
 *       character; reading in sequences of integers, doubles, or strings;
 *       and reading in all of the remaining input.
 *  </ul>
 *  <p>
 *  Historical note: {@code forGirls.std.StdIn} preceded {@code Scanner}; when
 ...
 *  Windows, and Linux.
 *  The methods in {@code forGirls.std.StdIn} are <em>blocking</em>, which means that they
 ...
 *  If the input begins with the optional byte-order mask, {@code forGirls.std.StdIn}
...
public final class StdIn {
    ...
    /*** begin: section (1 of 2) of code duplicated from In to forGirls.std.StdIn. */
    ...
    /*** end: section (1 of 2) of code duplicated from In to forGirls.std.StdIn. */
    ...
    //// begin: section (2 of 2) of code duplicated from In to forGirls.std.StdIn,
   ...
   /**
    ...
    //// end: section (2 of 2) of code duplicated from In to forGirls.std.StdIn
    
    
    // do this once when forGirls.std.StdIn is initialized
    static {
        resync();
    }

    /**
     * If forGirls.std.StdIn changes, use this to reinitialize the scanner.
     */
